...
rhone_indicators <- read_sf("data\\manual_digit\\Rhone\\5\\indicators_table.gdb", layer = "indicators_table")
...
rhone_0_5 = table_to_mean_and_quantiles('data\\manual_digit\\Rhone\\5\\indicators_table.gdb', "indicators_table")
rhone_0_5 = as.data.frame(rhone_0_5, value = rhone_0_5$rhone_0_5)
rhone_1 = table_to_mean_and_quantiles('data\\manual_digit\\Rhone\\10\\indicators_table.gdb', "indicators_table")
rhone_1 = as.data.frame(rhone_1, value = rhone_1$rhone_1)
rhone_1_5 = table_to_mean_and_quantiles('data\\manual_digit\\Rhone\\15\\indicators_table.gdb', "indicators_table")
rhone_1_5 = as.data.frame(rhone_1_5, value = rhone_1_5$rhone_1_5)
rhone_2 = table_to_mean_and_quantiles('data\\manual_digit\\Rhone\\20\\indicators_table.gdb', "indicators_table")
rhone_2 = as.data.frame(rhone_2, value = rhone_2$rhone_2)
rhone_2_5 = table_to_mean_and_quantiles('data\\manual_digit\\Rhone\\25\\indicators_table.gdb', "indicators_table")
rhone_2_5 = as.data.frame(rhone_2_5, value = rhone_2_5$rhone_2_5)
rhone_3 = table_to_mean_and_quantiles('data\\manual_digit\\Rhone\\30\\indicators_table.gdb', "indicators_table")
...
## Finding Differences -- Bako
rhone_differences <- find_diff(rhone_means_5per)
################################################
...
saane_indicators <- read_sf("data\\manual_digit\\Saane\\5\\indicators_table.gdb", layer = "indicators_table")
...
saane_0_5 = table_to_mean_and_quantiles("data\\manual_digit\\Saane\\5\\indicators_table.gdb", layer = "indicators_table")
saane_0_5 = as.data.frame(saane_0_5, value = saane_0_5$saane_0_5)
saane_1 = table_to_mean_and_quantiles("data\\manual_digit\\Saane\\10\\indicators_table.gdb", layer = "indicators_table")
saane_1 = as.data.frame(saane_1, value = saane_1$saane_1)
saane_1_5 = table_to_mean_and_quantiles("data\\manual_digit\\Saane\\15\\indicators_table.gdb", layer = "indicators_table")
saane_1_5 = as.data.frame(saane_1_5, value = saane_1_5$saane_1_5)
saane_2 = table_to_mean_and_quantiles("data\\manual_digit\\Saane\\20\\indicators_table.gdb", layer = "indicators_table")
saane_2 = as.data.frame(saane_2, value = saane_2$saane_2)
saane_2_5 = table_to_mean_and_quantiles("data\\manual_digit\\Saane\\25\\indicators_table.gdb", layer = "indicators_table")
saane_2_5 = as.data.frame(saane_2_5, value = saane_2_5$saane_2_5)
saane_3 = table_to_mean_and_quantiles("data\\manual_digit\\Saane\\30\\indicators_table.gdb", layer = "indicators_table")
...
## Finding Differences -- Bako
saane_differences <- find_diff(saane_means_5per)
################################################
...
sense_indicators <- read_sf("data\\manual_digit\\Sense\\5\\indicators_table.gdb", layer = "indicators_table")
...
sense_0_5 = table_to_mean_and_quantiles("data\\manual_digit\\Sense\\5\\indicators_table.gdb", layer = "indicators_table")
sense_0_5 = as.data.frame(sense_0_5, value = sense_0_5$sense_0_5)
sense_1 = table_to_mean_and_quantiles("data\\manual_digit\\Sense\\10\\indicators_table.gdb", layer = "indicators_table")
sense_1 = as.data.frame(sense_1, value = sense_1$sense_1)
sense_1_5 = table_to_mean_and_quantiles("data\\manual_digit\\Sense\\15\\indicators_table.gdb", layer = "indicators_table")
sense_1_5 = as.data.frame(sense_1_5, value = sense_1_5$sense_1_5)
sense_2 = table_to_mean_and_quantiles("data\\manual_digit\\Sense\\20\\indicators_table.gdb", layer = "indicators_table")
sense_2 = as.data.frame(sense_2, value = sense_2$sense_2)
sense_2_5 = table_to_mean_and_quantiles("data\\manual_digit\\Sense\\25\\indicators_table.gdb", layer = "indicators_table")
sense_2_5 = as.data.frame(sense_2_5, value = sense_2_5$sense_2_5)
sense_3 = table_to_mean_and_quantiles("data\\manual_digit\\Sense\\30\\indicators_table.gdb", layer = "indicators_table")
...
## Finding Differences -- Bako
sense_differences <- find_diff(sense_means_5per)
################################################

# rivers_whiskers = rbind(rhone_means_5per,saane_means_5per,sense_means_5per)
river_whiskers <- rbind(rhone_differences, saane_differences, sense_differences)
river_whiskers$number_of_nodes_diff[is.nan(river_whiskers$number_of_nodes_diff)] <- 1
man_dig_whisker_plot = quantiles_plot_B(river_whiskers, river_whiskers$sd,3) 
