...
## ----import data-------------------------------------------------------------------------------------------------------------------------------
rhone_indicators <- read_sf("data\\new_runs\\georef\\rhone\\10\\indicators_table.gdb", layer = "indicators_table")
rhone_indicators[is.na(rhone_indicators)] <- 0

sense_indicators <- read_sf("data\\new_runs\\georef\\sense\\10\\indicators_table.gdb", layer = "indicators_table")
sense_indicators[is.na(sense_indicators)] <- 0

saane_indicators <- read_sf("data\\new_runs\\georef\\saane\\10\\indicators_table.gdb", layer = "indicators_table")
...
rhone_1 = table_to_mean_and_quantiles("data\\new_runs\\georef\\rhone\\10\\indicators_table.gdb", layer = "indicators_table")
rhone_1 = as.data.frame(rhone_1, value = rhone_1$rhone_1)
rhone_2 = table_to_mean_and_quantiles("data\\new_runs\\georef\\rhone\\20\\indicators_table.gdb", layer = "indicators_table")
rhone_2 = as.data.frame(rhone_2, value = rhone_2$rhone_2)
rhone_3 = table_to_mean_and_quantiles("data\\new_runs\\georef\\rhone\\30\\indicators_table.gdb", layer = "indicators_table")
rhone_3 = as.data.frame(rhone_3, value = rhone_3$rhone_3)
rhone_4 = table_to_mean_and_quantiles("data\\new_runs\\georef\\rhone\\40\\indicators_table.gdb", layer = "indicators_table")
rhone_4 = as.data.frame(rhone_4, value = rhone_4$rhone_4)
rhone_5 = table_to_mean_and_quantiles("data\\new_runs\\georef\\rhone\\50\\indicators_table.gdb", layer = "indicators_table")
...
saane_1 = table_to_mean_and_quantiles("data\\new_runs\\georef\\saane\\10\\indicators_table.gdb", layer = "indicators_table")
saane_1 = as.data.frame(saane_1, value = saane_1$saane_1)
saane_2 = table_to_mean_and_quantiles("data\\new_runs\\georef\\saane\\20\\indicators_table.gdb", layer = "indicators_table")
saane_2 = as.data.frame(saane_2, value = saane_2$saane_2)
saane_3 = table_to_mean_and_quantiles("data\\new_runs\\georef\\saane\\30\\indicators_table.gdb", layer = "indicators_table")
saane_3 = as.data.frame(saane_3, value = saane_3$saane_3)
saane_4 = table_to_mean_and_quantiles("data\\new_runs\\georef\\saane\\40\\indicators_table.gdb", layer = "indicators_table")
saane_4 = as.data.frame(saane_4, value = saane_4$saane_4)
saane_5 = table_to_mean_and_quantiles("data\\new_runs\\georef\\saane\\50\\indicators_table.gdb", layer = "indicators_table")
...
sense_1 <- table_to_mean_and_quantiles("data\\new_runs\\georef\\sense\\10\\indicators_table.gdb", layer = "indicators_table")
sense_1 = as.data.frame(sense_1, value = sense_1$sense_1)
sense_2 = table_to_mean_and_quantiles("data\\new_runs\\georef\\sense\\20\\indicators_table.gdb", layer = "indicators_table")
sense_2 = as.data.frame(sense_2, value = sense_2$sense_2)
sense_3 = table_to_mean_and_quantiles("data\\new_runs\\georef\\sense\\30\\indicators_table.gdb", layer = "indicators_table")
sense_3 = as.data.frame(sense_3, value = sense_3$sense_3)
sense_4 = table_to_mean_and_quantiles("data\\new_runs\\georef\\sense\\40\\indicators_table.gdb", layer = "indicators_table")
sense_4 = as.data.frame(sense_4, value = sense_4$sense_4)
sense_5 = table_to_mean_and_quantiles("data\\new_runs\\georef\\sense\\50\\indicators_table.gdb", layer = "indicators_table")
...
########## PLOT BAKO ##########
#georeferencing_whisker_plot <- quantiles_plot_B(rivers_whiskers, rivers_whiskers$sd,3)


rhone_plot_g <- plotting_ind(rhone_means_5per,rhone_means_5per$sd)
saane_plot_g <- plotting_ind(saane_means_5per,saane_means_5per$sd)
sense_plot_g <- plotting_ind(sense_means_5per,sense_means_5per$sd)

georef_all <- ggarrange(rhone_plot_g,saane_plot_g, sense_plot_g, ncol = 3, common.legend = TRUE)
