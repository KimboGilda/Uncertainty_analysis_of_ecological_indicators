...
class ecologicalIndicators(object):
    ...
    def execute(self, parameters, messages):
        ...
        # added by bako
        #arcpy.Dissolve_management(out_gdb + '\\' + river_name + '_centerline_no_dis', out_gdb + '\\' + river_name + '_centerline_no_dis_V2')
        ...
        arcpy.Dissolve_management(out_gdb + '\\' + river_name + '_centerline_no_dis2', out_gdb + '\\' + river_name + '_centerline_v1', multi_part = 'SINGLE_PART')
        arcpy.management.RepairGeometry(out_gdb + '\\' + river_name + '_centerline_v1', 'DELETE_NULL', 'ESRI')
        arcpy.edit.TrimLine(out_gdb + '\\' + river_name + '_centerline_v1', "16 Meters", "DELETE_SHORT")
        arcpy.edit.TrimLine(out_gdb + '\\' + river_name + '_centerline_v1', "16 Meters", "DELETE_SHORT")
        # added by bako
        arcpy.Dissolve_management(out_gdb + '\\' + river_name + '_centerline_v1', out_gdb + '\\' + river_name + '_centerline')

    #Create nodes
        arcpy.analysis.Intersect(out_gdb + '\\' + river_name + '_centerline_v1', out_gdb + '\\' + river_name + '_nodes_no_dis', "ALL", None, "POINT")
        ...
        arcpy.PolygonToCenterline_topographic(out_gdb + '\\' + river_name + '_union_dis', out_gdb + '\\' + river_name + '_mainline_v1')
        arcpy.Dissolve_management(out_gdb + '\\' + river_name + '_mainline_v1', out_gdb + '\\' + river_name + '_mainline')
    #
    # # #
        ...
        arcpy.Copy_management(out_gdb + '\\' + river_name + '_centerline_no_dis', out_gdb + '\\' + river_name + '_total_sinuosity2')
        arcpy.management.AlterField(out_gdb + '\\' + river_name + '_total_sinuosity2', 'Shape_Length', None, 'centerline_length')
        arcpy.JoinField_management(out_gdb + '\\' + river_name + '_total_sinuosity2', "OBJECTID", out_gdb + '\\' + river_name + '_cartesian_distance', "OBJECTID")
        arcpy.AddField_management(out_gdb + '\\' + river_name + '_total_sinuosity2','total_sinuosity','DOUBLE')

        # added by bako
        arcpy.Dissolve_management(out_gdb + '\\' + river_name + '_total_sinuosity2', out_gdb + '\\' + river_name + '_total_sinuosity')
