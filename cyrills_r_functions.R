...
table_to_mean_and_quantiles = function(path, layer_name){
  input = read_sf(path, layer_name)
  input_wo_first_row = input[-1,]
  input_wo_first_row <- input_wo_first_row[!is.na(input_wo_first_row$shoreline),]
  input_wo_first_row <- input_wo_first_row[!is.na(input_wo_first_row$sinuosity),]
  input_wo_first_row <- input_wo_first_row[!is.na(input_wo_first_row$total_sinuosity),]
...
add_whiskers = function(means_table, size,originals){
  ...
  means_table = within(means_table,{
    ...
    total_sinuosity_ref = originals[3]
    })
  ...
  means_table = within(means_table,{
    ...
    number_of_nodes_ref = originals[4]
    })
  ...
  means_table = within(means_table,{
    ...
    width_variability_ref = originals[5]
    })
...
whiskers_plot_width = function(whiskers_table,x_var,column){
  shoreline_plot_5 = ggplot()+
    geom_point(data = whiskers_table, aes(x = x_var, y = shoreline, color=river))+ #,shape = whiskers_table$shoreline_shape
    guides(color=FALSE)+
    labs(x='minimum width (m)') + 
    geom_hline(yintercept = whiskers_table$shoreline_ref, linetype = "dotted", data = whiskers_table) + 
    geom_hline(yintercept = 1.05*whiskers_table$shoreline_ref, linetype = "dotted", whiskers_table) + 
    geom_hline(yintercept = 0.95*whiskers_table$shoreline_ref, linetype = "dotted", whiskers_table) + 
    expand_limits(y = 0)+
    theme_classic(base_size = 12, base_family = "")+
    theme(legend.position = 'none',
          axis.title.y=element_blank()
  ...
  sinuosity_plot_5 = ggplot()+
    geom_point(data = whiskers_table, aes(x = x_var, y = sinuosity, color=river),shape = whiskers_table$sinuosity_shape)+
    guides(color=FALSE)+
    labs(x='minimum width (m)') +
    geom_hline(yintercept = whiskers_table$sinuosity_ref, linetype = "dotted") +
    geom_hline(yintercept = 1.05*whiskers_table$sinuosity_ref, linetype = "dotted") +
    geom_hline(yintercept = 0.95*whiskers_table$sinuosity_ref, linetype = "dotted") +
    expand_limits(y = 0)+
    theme_classic(base_size = 12, base_family = "")+
    theme(legend.position = 'none',
          axis.title.y=element_blank()
  ...
  total_sinuosity_plot_5 = ggplot()+
    geom_point(data = whiskers_table, aes(x = x_var, y = total_sinuosity, color=river),shape = whiskers_table$total_sinuosity_shape)+
    guides(color=FALSE)+
    labs(x='minimum width (m)')+
    geom_hline(yintercept = whiskers_table$total_sinuosity_ref, linetype = "dotted") +
    geom_hline(yintercept = 1.05*whiskers_table$total_sinuosity_ref, linetype = "dotted") +
    geom_hline(yintercept = 0.95*whiskers_table$total_sinuosity_ref, linetype = "dotted") +
    expand_limits(y = 0)+
    theme_classic(base_size = 12, base_family = "")+
    theme(legend.position = 'none',
          axis.title.y=element_blank()
  ...
  number_of_nodes_plot_5 = ggplot()+
    geom_point(data = whiskers_table, aes(x = x_var, y = number_of_nodes, color=river),shape = whiskers_table$number_of_nodes_shape)+
    guides(color=FALSE)+
    labs(x='minimum width (m)')+
    geom_hline(yintercept = whiskers_table$number_of_nodes_ref, linetype = "dotted") +
    geom_hline(yintercept = 1.05*whiskers_table$number_of_nodes_ref, linetype = "dotted") +
    geom_hline(yintercept = 0.95*whiskers_table$number_of_nodes_ref, linetype = "dotted") +
    expand_limits(y = 0)+
    theme_classic(base_size = 12, base_family = "")+
    theme(legend.position = 'none',
          axis.title.y=element_blank()
  ...
  width_variability_plot_5 = ggplot()+
    geom_point(data = whiskers_table, aes(x = x_var, y = width_variability, color=river),shape = whiskers_table$width_variability_shape)+
    guides(color=FALSE)+
    labs(x='minimum width (m)')+
    geom_hline(yintercept = whiskers_table$width_variability_ref, linetype = "dotted") +
    geom_hline(yintercept = 1.05*whiskers_table$width_variability_ref, linetype = "dotted") +
    geom_hline(yintercept = 0.95*whiskers_table$width_variability_ref, linetype = "dotted") +
    expand_limits(y = 0)+
    theme_classic(base_size = 12, base_family = "")+
    theme(legend.position = 'none',
          axis.title.y=element_blank()
